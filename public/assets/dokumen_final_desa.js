...
$(document).ready(function () {
    ...
    $('#tabelDokumenFinal').DataTable({
        ...
        displayLength: 25,
        ajax: {
            url: BASE_URL + "/desa/get-dokumen-final-desa",
        },
        columns: [
            {
                orderable: false,
            ...
            },
            {
                ...
                data: function (data) {
                    return `
                    <div class="text-center">
                        <a  class="btn btn-sm btn-primary" href="${BASE_URL}/${data.path_approve}" target="_blank">Lihat Dokumen</a>
                    </div>`;
                }
            },
        ],
