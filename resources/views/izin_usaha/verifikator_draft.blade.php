                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info mb-4">
                            <i class="bi bi-info-circle"></i> Halaman ini menampilkan pengajuan izin usaha yang masih
                            berstatus <strong>DRAFT</strong>. Pengajuan dengan status ini belum bisa diverifikasi oleh
                            Verifikator. Pastikan BUMDes untuk melakukan submit agar pengajuan dapat diproses lebih lanjut.
                        </div>
                        <div class="table-responsive">
                            <table class="table table-hover mb-0" id="tabelIzinUsahaDraft" style="width: 100%;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tabelIzinUsahaDraft').DataTable({
                ...
                displayLength: 25,
                ajax: {
                    url: BASE_URL + "/verifikasi/get-datatables-draft",
                },
                columns: [{
                        orderable: false,
                        data: function(data) {
